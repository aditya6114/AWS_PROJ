...
import CreateDonationForm from '../../components/createDonation';
...
export default function DonorDashboard() {
  ...
  useEffect(() => {
    if (!loading && !user) {
      router.push('/');
    } else if (!loading && user && user.role !== 'donor') {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-lg md:text-xl text-stone-300 max-w-2xl mx-auto font-light">
              Share food, spread kindness. Create donations to help those in need.
            </p>
